  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 md:pt-48 pb-24">
      <div className="container mx-auto px-6 relative z-20 text-center">
        ...
        >
          <a href="#pricing" className="group px-10 py-5 bg-[#FF7F00] text-white font-black rounded-2xl shadow-2xl shadow-orange-500/20 transition-all duration-300 hover:shadow-orange-500/40 hover:scale-105 active:scale-95 text-[10px] tracking-[0.3em] uppercase whitespace-nowrap">
            <span className="flex items-center">
                SEE PRICING <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" size={16} />
            </span>
          </a>

          <a href="/training" className="group px-10 py-5 bg-slate-900 text-white font-black rounded-2xl shadow-2xl shadow-slate-900/10 transition-all duration-300 hover:bg-[#0077FF] hover:scale-105 active:scale-95 text-[10px] tracking-[0.3em] uppercase whitespace-nowrap">
            <span className="flex items-center">
                JOIN TRAINING <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" size={16} />
            </span>
          </a>
          
          <div className="px-8 py-4 bg-white/80 backdrop-blur-md border border-slate-100 text-slate-700 rounded-2xl flex flex-col items-center justify-center min-w-[220px] shadow-sm">
