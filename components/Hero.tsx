    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-40 md:pt-48 pb-20">
      <div className="container mx-auto px-6 relative z-20 text-center">
        <motion.div
          ...
          className="inline-flex items-center space-x-3 px-8 py-3 rounded-full border border-slate-100 bg-white/50 backdrop-blur-md shadow-sm mb-12"
        >
          <Sparkles size={18} className="text-[#FF7F00]" />
          <span className="text-xs md:text-sm font-bold uppercase tracking-[0.4em] text-slate-500">ARISE AI MARKETING AGENCY CROSS AFRICA</span>
        </motion.div>
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl lg:text-9xl font-black mb-12 leading-[0.95] tracking-tighter text-slate-900"
        >
          Everyone Markets. <br />
        ...
        <motion.p 
          ...
          className="text-lg md:text-2xl text-slate-600 max-w-4xl mx-auto mb-16 leading-relaxed font-light"
        >
        ...
        >
          ...
          <div className="px-12 py-5 glass-panel border border-slate-100 text-slate-700 rounded-2xl flex flex-col items-center justify-center min-w-[240px]">
            <div className="flex items-center space-x-2 mb-1">
              <Phone size={16} className="text-[#0077FF]" />
              <span className="text-[13px] font-black uppercase tracking-widest text-slate-500">Call Us</span>
            </div>
            <span className="text-xl font-black tracking-tighter text-slate-900">+250 794 785 167</span>
          </div>
        </motion.div>
      </div>
