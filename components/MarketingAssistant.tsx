  ...
  const features = [
    {
      ...
      icon: <MessageSquare className="text-[#357FA6]" size={28} />,
    ...
    },
    {
      ...
      icon: <HeartHandshake className="text-[#CE5826]" size={28} />,
    ...
    },
    {
      ...
      icon: <Share2 className="text-[#357FA6]" size={28} />,
    ...
    },
    {
      ...
      icon: <Rocket className="text-[#CE5826]" size={28} />,
      tag: "Market Impact"
    }
  ];
      ...
      <div className="flex flex-col lg:flex-row items-center gap-20">
        <div className="lg:w-1/2">
          <div className="inline-flex items-center space-x-4 px-6 py-2 bg-blue-50 rounded-full border border-blue-100 mb-8">
            <Users size={18} className="text-[#357FA6]" />
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#357FA6]">Your Dedicated Team</span>
          </div>
          
          <h2 className="text-4xl md:text-6xl font-black mb-10 uppercase tracking-tighter text-slate-900 leading-[0.9]">
            Your Elite <br />
            <span className="text-[#CE5826]">Marketing</span> <br />
            Assistant.
          </h2>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4 p-6 rounded-3xl bg-slate-50 border border-slate-100">
              <ShieldCheck className="text-[#357FA6]" size={24} />
          ...
          {features.map((feature, index) => (
            <motion.div
              ...
              transition={{ delay: index * 0.1 }}
               className="p-8 rounded-[2.5rem] bg-white border border-slate-100 hover:border-[#357FA6]/30 transition-all duration-500 shadow-sm hover:shadow-xl group"
             >
               ...
               <span className="text-[9px] font-black text-[#CE5826] uppercase tracking-[0.3em] mb-3 block">
                 {feature.tag}
               </span>
