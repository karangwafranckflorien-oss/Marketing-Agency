...
const sectors = [
  { name: 'Restaurants', icon: <Utensils className="text-[#357FA6]" size={32} />, delay: 0 },
  { name: 'Hotels', icon: <Hotel className="text-[#CE5826]" size={32} />, delay: 0.1 },
  { name: 'Schools', icon: <School className="text-[#357FA6]" size={32} />, delay: 0.2 },
  { name: 'Companies', icon: <Building2 className="text-[#CE5826]" size={32} />, delay: 0.3 },
  { name: 'NGOs', icon: <Heart className="text-[#357FA6]" size={32} />, delay: 0.4 },
  { name: 'Any Business', icon: <Zap className="text-[#CE5826]" size={32} />, delay: 0.5 },
];
    ...
    <div className="container mx-auto px-6 py-12">
      <div className="text-center mb-24">
        <div className="flex items-center justify-center space-x-4 mb-6">
          <ShieldCheck size={20} className="text-[#CE5826]" />
        ...
        <h2 className="text-4xl md:text-6xl font-black mb-8 uppercase tracking-tighter text-slate-900 leading-tight">
          Industries We <br />
          <span className="text-[#357FA6]">Elevate.</span>
        </h2>
        ...
        <div className="w-24 h-1.5 bg-[#CE5826] mx-auto mt-12 rounded-full" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8">
        {sectors.map((sector, index) => (
          <motion.div
            ...
            className="group relative flex flex-col items-center p-10 rounded-[3rem] bg-white border border-slate-100 shadow-sm hover:shadow-2xl hover:border-[#357FA6]/30 transition-all duration-500 cursor-pointer text-center"
          ...
          >
            ...
            <div className="mt-auto flex items-center space-x-2 text-[#CE5826] opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
      ...
      >
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#357FA6]/5 rounded-full blur-[100px] -z-10" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#CE5826]/5 rounded-full blur-[100px] -z-10" />
        ...
        <h3 className="text-3xl md:text-5xl font-black mb-10 uppercase tracking-tighter leading-tight text-slate-900">
          Elite <span className="text-[#CE5826]">Proof</span> for Elite Visionaries.
        </h3>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mb-16">
          <div className="flex items-center space-x-4 text-left">
            <div className="w-14 h-14 rounded-2xl bg-blue-50 flex items-center justify-center text-[#357FA6] shadow-inner">
              <Zap size={28} />
            </div>
            <div>
          ...
          <div className="flex items-center space-x-4 text-left">
            <div className="w-14 h-14 rounded-2xl bg-orange-50 flex items-center justify-center text-[#CE5826] shadow-inner">
              <Building2 size={28} />
            </div>
            <div>
        ...
        <button 
          ...
          className="group inline-flex items-center space-x-6 px-14 py-8 bg-slate-900 text-white rounded-[2.5rem] font-black text-xs uppercase tracking-[0.5em] hover:bg-[#357FA6] transition-all shadow-2xl active:scale-95"
        >
