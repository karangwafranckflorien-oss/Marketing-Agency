    ...
    <div className="container mx-auto px-6 py-24">
      ...
      <div className="mb-40 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-10 uppercase tracking-tighter text-slate-900 leading-[0.9]">
            The Future of <br />
            <span className="text-[#FF7F00]">Marketing Engineering.</span>
          </h2>
        </div>
        
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <p className="text-slate-800 text-lg font-bold leading-relaxed uppercase tracking-widest opacity-90">
              Arise AI Marketing Agency, a subsidiary of <span className="text-[#0077FF]">Arise Digital Solutions Ltd. (Rwanda)</span>, is a next-generation marketing firm that leverages cutting-edge Artificial Intelligence to deliver "Elite Proof" results.
            </p>
          ...
          <div className="p-12 bg-slate-900 rounded-[3rem] text-white relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-[#FF7F00]/20 rounded-full blur-3xl" />
            <h4 className="text-xl font-black mb-6 uppercase tracking-tighter text-[#FF7F00]">Our Mission</h4>
      ...
      <div className="mb-40">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-7xl font-black mb-10 uppercase tracking-tighter text-slate-900 leading-[0.85]">
            Our <span className="text-[#FF7F00]">Elite</span> Proof.
          </h2>
          <p className="text-slate-600 max-w-3xl mx-auto text-base md:text-lg font-bold uppercase tracking-widest leading-relaxed opacity-90">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {[
            ...
            <motion.div 
              ...
              className="p-12 rounded-[3.5rem] bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500"
            >
              <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-8">
                {item.icon}
              </div>
              <h4 className="text-xl font-black mb-4 uppercase text-slate-900 tracking-tight">{item.title}</h4>
              <p className="text-slate-500 text-sm font-medium leading-relaxed uppercase tracking-widest">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      <div className="mb-40">
        <div className="flex items-center justify-center md:justify-start space-x-8 mb-16">
          ...
          <h3 className="text-3xl font-black uppercase tracking-tighter text-slate-900">Service Architecture</h3>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {[
            ...
            <div key={i} className="p-12 rounded-[3.5rem] bg-white border border-slate-100 shadow-sm">
              ...
              <ul className="space-y-4">
                {service.items.map((item, j) => (
                  <li key={j} className="flex items-center space-x-3">
                    ...
                    <span className="text-[11px] font-black text-slate-600 uppercase tracking-widest">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <div className="mb-40">
        <div className="flex items-center justify-center md:justify-start space-x-8 mb-16">
          ...
          <h3 className="text-3xl font-black uppercase tracking-tighter text-slate-900">Implementation Roadmap</h3>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {roadmapSteps.map((step, i) => (
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full blur-3xl -z-10 group-hover:bg-[#0077FF]/20 transition-all duration-500" />
              <div className="text-[10px] font-black text-[#FF7F00] uppercase tracking-[0.4em] mb-6">{step.phase}</div>
      ...
      {/* Tech Stack Section */}
      <div className="p-16 md:p-24 rounded-[5rem] bg-white border-2 border-slate-100 shadow-2xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#0077FF]/5 rounded-full blur-[120px] -z-10" />
        <div className="text-center mb-16">
          <h3 className="text-3xl font-black uppercase tracking-tighter text-slate-900 mb-6">Our Elite Tech Stack</h3>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {[
            ...
            <div key={i} className="px-8 py-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center space-x-3 hover:border-[#0077FF]/30 transition-all cursor-default">
              <CheckCircle2 size={14} className="text-[#0077FF]" />
              <span className="text-[11px] font-black text-slate-900 uppercase tracking-widest">{tech}</span>
            </div>
          ))}
        </div>
      </div>
