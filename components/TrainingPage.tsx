    ...
    <div className="min-h-screen bg-white pb-24">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-32">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-8xl font-black mb-12 leading-[0.85] tracking-tight text-slate-900 uppercase"
          >
            Master the <br />
      ...
      <section className="container mx-auto px-6 mb-32">
        <div className="text-center mb-16">
          <p className="text-[11px] font-black text-[#0077FF] uppercase tracking-[0.4em] mb-4 bg-blue-50 inline-block px-8 py-3 rounded-full border border-blue-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {modules.map((module, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-10 rounded-[3rem] bg-white border-2 border-slate-100 hover:border-[#0077FF] transition-all group shadow-sm hover:shadow-2xl hover:shadow-blue-500/10 flex flex-col relative overflow-hidden min-h-[450px]"
            >
              {/* Decorative Background Pattern */}
              <div className="absolute -right-8 -top-8 w-32 h-32 bg-blue-50 rounded-full opacity-50 group-hover:bg-[#0077FF]/10 transition-colors duration-500 blur-3xl" />
              
              <div className="w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-[#0077FF] transition-all duration-300 relative z-10">
              ...
              <h3 className="text-2xl font-black mb-4 tracking-tight text-slate-900 leading-tight relative z-10">{module.title}</h3>
              
              <p className="text-slate-600 text-[10px] leading-relaxed mb-8 uppercase tracking-widest font-black opacity-90 relative z-10">
                {module.description}
              </p>
              
              <div className="mt-auto relative z-10">
                <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#FF7F00] mb-6 border-b border-slate-100 pb-2">Curriculum Highlights</h4>
                <ul className="space-y-4">
                  {module.details.map((detail, i) => (
                    <li key={i} className="flex items-start text-[11px] font-black text-slate-500 uppercase tracking-widest group-hover:text-slate-900 transition-colors">
                      <CheckCircle2 size={14} className="mr-3 text-[#0077FF] shrink-0 mt-0.5" />
                      {detail}
                    </li>
                  ))}
                </ul>
              ...
              <div className="absolute bottom-0 left-0 w-full h-1.5 bg-gradient-to-r from-[#0077FF] to-[#FF7F00] opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
          ))}
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            <div>
              <h2 className="text-4xl md:text-5xl font-black mb-12 tracking-tighter leading-none">
                Program <span className="text-[#FF7F00]">Structure</span> <br />
                & Schedule
              </h2>
              ...
              <div className="space-y-12">
                <div>
                  <h3 className="text-xl font-black uppercase tracking-[0.3em] text-[#FF7F00] mb-6 flex items-center">
                    <div className="w-8 h-1 bg-[#FF7F00] mr-4" /> Class Schedule
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                      <h4 className="font-black uppercase tracking-widest text-[#0077FF] mb-4">📍 Physical Classes</h4>
                    ...
                    <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                      <h4 className="font-black uppercase tracking-widest text-[#FF7F00] mb-4">💻 Online Classes</h4>
                ...
                <div>
                  <h3 className="text-xl font-black uppercase tracking-[0.3em] text-[#0077FF] mb-6 flex items-center">
                    <div className="w-8 h-1 bg-[#0077FF] mr-4" /> Payment Details
                  </h3>
                  <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                    <ul className="space-y-4 text-xs font-black uppercase tracking-widest text-slate-300">
                      <li className="flex items-center"><CheckCircle2 size={16} className="mr-3 text-[#FF7F00]" /> Payment after application confirmation</li>
                      <li className="flex items-center"><CheckCircle2 size={16} className="mr-3 text-[#FF7F00]" /> Office or Online payment allowed</li>
                      <li className="flex items-center bg-[#FF7F00]/10 p-4 rounded-xl border border-[#FF7F00]/20">
                        <span className="text-[#FF7F00]">MoMo Code: 002680 (Arise Company)</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="p-12 md:p-16 rounded-[3rem] bg-white text-slate-900 shadow-2xl relative lg:sticky lg:top-32">
              <div className="absolute -top-8 -right-8 w-32 h-32 bg-[#FF7F00] rounded-full flex flex-col items-center justify-center text-white font-black text-center p-4 rotate-12 shadow-2xl border-4 border-white z-20">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tighter mb-12">Training <span className="text-[#0077FF]">Fees</span></h3>

              <div className="space-y-12 mb-16">
                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
                  <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#0077FF] block mb-4">Physical Training</span>
                ...
                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
                  <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#FF7F00] block mb-4">Online Training</span>
                  <div className="flex items-baseline">
              ...
              <div className="space-y-6 mb-12">
                <div className="flex items-center space-x-4">
                  <Award size={20} className="text-[#0077FF]" />
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-600">Official Certificate Included</span>
                </div>
                <div className="flex items-center space-x-4">
                  <Wifi size={20} className="text-[#FF7F00]" />
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-600">High-Speed WiFi (Physical)</span>
                </div>
              </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8 md:p-12">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  ...
                  <p className="text-[#0077FF] text-[10px] md:text-xs font-black uppercase tracking-widest mt-1">Professional Production</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="aspect-[9/16] rounded-[3rem] overflow-hidden bg-slate-900 relative group shadow-2xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8">
              <div>
                ...
                <p className="text-[#FF7F00] text-[10px] font-black uppercase tracking-widest mt-1">Viral Content Strategy</p>
              </div>
            </div>
          </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8 md:p-12">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  ...
                  <p className="text-[#0077FF] text-[10px] md:text-xs font-black uppercase tracking-widest mt-1">Elite Motion Graphics</p>
                </div>
              </div>
            </div>
          </div>
